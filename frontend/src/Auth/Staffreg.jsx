...
function Staff() {
  ...
  const handlesignup = async (e) => {
    ...
    try {
      const res = await axios.post("https://inventorymanagmentsystembackend.onrender.com/auth/staffregactivation", data);
      // console.log(res.data.tempdata);
      if (res.status === 200) {
        localStorage.setItem("tempdata", res.data.tempdata); 
        toast.success(res.data.message || "OTP sent successfully!", {
          onClose: () => Navigate("/staffactivation"),
        });
      } else {
            ...
            <div className="row justify-content-center">
              <div className="col-12 col-sm-10 col-md-8">
                <div className="heading mt-2 mt-md-3">
                  <h2 className="mb-0 text-center">Become a Staff</h2>
