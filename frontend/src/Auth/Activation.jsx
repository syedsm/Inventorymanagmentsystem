...
function Activation() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("https://inventorymanagmentsystembackend.onrender.com/auth/verify_otp", {
        otp,
        email: tempmail,
      });
              ...
              <div className="text-center mb-4">
                ...
                <div className="d-flex justify-content-center mb-3">
                  <OtpInput
                    ...
                    onChange={setOtp}
                    numInputs={4}
                    renderSeparator={<span className="mx-1">-</span>} // Adds spacing between the inputs
                    renderInput={(props) => (
                      <input
                        {...props}
                        className="form-control text-center"
                        style={{ width: "50px", height: "50px" }} // Set a specific size for the OTP input fields
                      />
                    )}
                  />
                </div>
