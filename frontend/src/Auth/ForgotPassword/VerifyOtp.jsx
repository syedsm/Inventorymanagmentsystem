...
function Activation() {
  ...
  const handleSubmit = async (e) => {
    ...
    // }
    try {
      const response = await axios.post("https://inventorymanagmentsystembackend.onrender.com/api/auth/forgot_verify_otp", {
        otp: otp,
        email: tempmail,
      });
  ...
  const handleresend = async (e) => {
    ...
    try {
      const response = await axios.post("https://inventorymanagmentsystembackend.onrender.com/api/auth/forgot_resend_otp", {
        email: tempmail,
      });
